...
| 13.2 | 6 | Tiedostojen lähetys toimii fronttipuolella. Backendissä tiedostonsiirrossa kontrollit ja queryt valmiina uusien sijaintien lisäämiselle, vielä varsinaisen kuvan lisääminen kesken.
| yht   | 45 | | 
